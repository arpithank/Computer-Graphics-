...
public class OpenGLES20Activity extends Activity {
    ...
    public void onCreate(Bundle pSavedInstanceState) {
        ...
        Button rotateButton = getButton(R.drawable.bluebutton, "Rot", true, 0);
        toprow.addView(rotateButton);
        toprow.addView(getBuffer());

        Button txyButton = getButton(R.drawable.darkbluebutton, "T-xy", true, 1);
        toprow.addView(txyButton);
        toprow.addView(getBuffer());

        Button txzButton = getButton(R.drawable.darkbluebutton, "T-xz", true, 2);
        toprow.addView(txzButton);
        toprow.addView(getBuffer());

        Button scaleButton = getButton(R.drawable.darkbluebutton, "Scale", true, 3);
        ...
        Button obj1Button = getButton(R.drawable.bluebutton, "Obj1", false, 0);
        bottomrow.addView(obj1Button);
        bottomrow.addView(getBuffer());

        Button obj2Button = getButton(R.drawable.darkbluebutton, "Obj2", false, 1);
        bottomrow.addView(obj2Button);
        bottomrow.addView(getBuffer());

        Button obj3Button = getButton(R.drawable.darkbluebutton, "Obj3", false, 2);
        bottomrow.addView(obj3Button);
        bottomrow.addView(getBuffer());

        Button camButton = getButton(R.drawable.darkbluebutton, "Cam", false, 3);
